...
namespace MetaScope.ViewModels
{
	...
	public class PropertyFeature
	{
		...
		public static PropertyFeature BuildProperty( DataFeature df )
		{
			...
			// In .NET 8+ / Avalonia, AssemblyBuilder.DefineDynamicAssembly
			// does not support RunAndSave.  We use RunAndCollect instead.
			// The dynamic type extends PropertyFeature with extra string
			// properties for each GFF attribute key.
			...
			string			strClass		= string.Format( "PropertyFeatureExtension" );
